...
export const mountMarketingApp = (el: HTMLElement | null, navigationObject: {onNavigate?: LocationListener, defaultHistory?: typeCreateBrowserHistory,  initialPath?: InitialEntry[] }) => {
